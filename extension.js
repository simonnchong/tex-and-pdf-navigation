...
function activate(context) {
    ...
    // Apply double-click reverse sync setting to LaTeX Workshop on activation
    ...
    context.subscriptions.push(
        vscode.workspace.onDidSaveTextDocument(doc => {
            if (doc.languageId === 'latex' || doc.languageId === 'tex') provider.refresh(doc.uri);
        })
    );
    ...
    // Outline item click: navigate to .tex line and sync PDF
    context.subscriptions.push(
    ...
    // Scroll listener: sync PDF to visible center of .tex editor when enabled
    context.subscriptions.push(
